            ...
            <div class="card">
                <div class="card-body">           
                    ...
                    <div class="text-right mb-3">
                        <a href="{{ route("{$route}.download", ['category_id' => $category_id, 'file_gallery_id' => 1]) }}" class="btn btn-primary width-lg"><i data-feather="download" class="icon-xs"></i> download files</a>
