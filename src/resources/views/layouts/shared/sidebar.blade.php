<div class="left-side-menu">
    <div class="media user-profile mt-2 mb-2">
        ...
        <div class="media-body">
            ...
            <span class="pro-user-desc">{{ Auth::user()->category->first()->contents->first()->title }}</span>
        </div>
        <div class="dropdown align-self-center profile-dropdown-menu">
            ...
            <div class="dropdown-menu profile-dropdown">
                ...
                <a href="{{ route('user.form', ['id' =>  Auth::user()->id, 'category_id' => '']) }}" class="dropdown-item notify-item"> 
    ...
    <div class="sidebar-content">        
        <div id="sidebar-menu" class="slimscroll-menu">
            @include('console-service::layouts.shared.app-menu')
        </div>
